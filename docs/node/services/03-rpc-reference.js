...
const help = {
  "validatorstate": [
      ...
      {
          "function": "revert",
          "declaration": "private function validatorstate::revert(uint64 number) returns { new_tip_block_number: uint64, old_tip_block_number: uint64, block_delta: int64, transaction_delta: int64, state_delta: int64, is_fork: bool }",
  ...
  "mempoolstate": [
      ...
      },
      {
          ...
          "declaration": "private function mempoolstate::simulatebridge(string asset, string bridge_hash, string to_address, decimal to_value) returns superchain_transaction",
          "description": "build an off-chain attestation transaction payload using off-chain node"
      },
      {
      ...
      },
      {
          ...
          "declaration": "public view function mempoolstate::submittransaction(string message_hash) returns uint256",
