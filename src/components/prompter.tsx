        ...
        <AlertDialog.Content maxWidth="450px">
          <AlertDialog.Title>
            <Flex justify="between" align="center">
              ...
              <Badge size="2" color={metadata.trulyTrustless ? undefined : 'red'}>{ metadata.trulyTrustless ? 'SECURE' : 'NOT SECURE' }</Badge>
            </Flex>
          </AlertDialog.Title>
          <Card mb="4">
            <Flex justify="between" align="center">
              <Flex gap="2">
                <Avatar src={entity.about.favicon || ''} fallback={metadata.symbol || '?'} size="4" color={metadata.trulyTrustless ? undefined : 'amber'} />
